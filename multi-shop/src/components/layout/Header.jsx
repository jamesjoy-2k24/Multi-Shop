...
function Header() {
  return (
    <div>
       <div className="main ">
        <div className=" fixed navbar  flex justify-center p-3 bg-black shadow-gray-50 text-white text-[18px] lg:px-60 px-[5px] w-full   ">
        ...
        <div className="heder w-full h-40 bg-white shadow-md lg:px-10 md:px-10 px-3  ">
